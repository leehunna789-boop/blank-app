...
st.markdown('<div class="run-text"><marquee scrollamount="10">อยู่นิ่งๆ ไม่เจ็บตัว... สถานีเพลง 6D ลูกพี่จัดให้!</marquee></div>', unsafe_allow_html=True)

# --- 5. คลังเพลง (ดึงจาก GitHub) ---
st.write("### 💿 รายการเพลงของลูกพี่")
...
# --- 6. ส่วนของเพื่อน (รูปจะอยู่ล่างสุดจริงๆ) ---
st.write("---")
