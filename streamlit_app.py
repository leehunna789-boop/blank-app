...
st.markdown("""
    ...
    .marquee-container {
        ...
        overflow: hidden;
        white-space: nowrap;
        background: #FF4B4B; /* สีพื้นหลังแถบวิ่ง */
        padding: 10px 0;
        border-radius: 10px;
        margin-bottom: 20px;
    }
    ...
    <div class="marquee-container">
        <div class="marquee-text">
            📢 ยินดีต้อนรับเข้าสู่สถานี อยู่นิ่งๆ ไม่เจ็บตัว ... ขอเพลงกันเข้ามาได้เลยครับ! 🎵 
            ดีเจกำลังจัดเตรียมเพลงให้คุณอยู่ 🎧 ขอบคุณที่ติดตามรับฟังครับ ✨
        </div>
    </div>
    """, unsafe_allow_html=True)
